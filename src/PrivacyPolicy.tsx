export default function PrivacyPolicy() {
  return (
    <>
      <article className="prose prose-lg md:prose-2xl mx-auto dark:prose-invert">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Stopwatches.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Stopwatches, accessible from{" "}
              <a
                href="https://mihmal.ru/"
